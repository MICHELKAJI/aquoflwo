...
export default function SectorManagerDashboard({ currentUser, site, notifications }: SectorManagerDashboardProps) {
  ...
  // Ajout refs pour scroll
  const dashboardRef = useRef<HTMLDivElement>(null);
  const householdsRef = useRef<HTMLDivElement>(null);
  const siteInfoRef = useRef<HTMLDivElement>(null);
  const autoAlertsRef = useRef<HTMLDivElement>(null);
  const siteAlertsRef = useRef<HTMLDivElement>(null);
  ...
  return (
    <div className="flex max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Sidebar Menu */}
      <nav className="hidden md:block w-56 mr-8">
        <div className="sticky top-24">
          <ul className="space-y-2">
            <li>
              <button onClick={() => handleMenuClick(dashboardRef)} className="w-full text-left px-4 py-2 rounded hover:bg-blue-50 font-medium text-blue-900">Dashboard</button>
            </li>
            <li>
              <button onClick={() => handleMenuClick(householdsRef)} className="w-full text-left px-4 py-2 rounded hover:bg-blue-50 font-medium text-blue-900">Sector Households</button>
            </li>
            <li>
              <button onClick={() => handleMenuClick(siteInfoRef)} className="w-full text-left px-4 py-2 rounded hover:bg-blue-50 font-medium text-blue-900">Site Information</button>
            </li>
            <li>
              <button onClick={() => handleMenuClick(autoAlertsRef)} className="w-full text-left px-4 py-2 rounded hover:bg-blue-50 font-medium text-blue-900">Automatic Alerts</button>
            </li>
            <li>
              <button onClick={() => handleMenuClick(siteAlertsRef)} className="w-full text-left px-4 py-2 rounded hover:bg-blue-50 font-medium text-blue-900">Site Alerts</button>
            </li>
          </ul>
        </div>
      </nav>
      ...
      <div className="flex-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Households List */}
          <div ref={householdsRef} id="households-section" className="bg-white rounded-lg shadow-sm border">
          ...
          <div className="space-y-6">
            {/* Site Info */}
            <div ref={siteInfoRef} id="site-info-section" className="bg-white rounded-lg shadow-sm border p-6">
            ...
            {/* Recent Alerts */}
            <div ref={autoAlertsRef} id="auto-alerts-section" className="bg-white rounded-lg shadow-sm border">
              <div className="p-6 border-b border-gray-200">
          ...
          {/* Alerts Section */}
          <div ref={siteAlertsRef} id="site-alerts-section" className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b border-gray-200">
              <div className="flex justify-between items-center">
                <div>
